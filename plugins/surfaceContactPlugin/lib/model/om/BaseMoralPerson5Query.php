 ...
 */
class BaseMoralPerson5Query extends MoralPersonQuery {

    /**
     * Returns a new MoralPerson5Query object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return MoralPerson5Query
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof MoralPerson5Query) {
            return $criteria;
        }
        $query = new MoralPerson5Query();
        if (null !== $modelAlias) {
    ...
    /**
     * Filters the query to target only MoralPerson5 objects.
     */
    public function preSelect(PropelPDO $con)
    {
        $this->addUsingAlias(ContactPeer::TYPE, ContactPeer::CLASSKEY_105);
    }
