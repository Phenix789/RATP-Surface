 ...
 */
class BasePhysicalPerson2Query extends PhysicalPersonQuery {

    /**
     * Returns a new PhysicalPerson2Query object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return PhysicalPerson2Query
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof PhysicalPerson2Query) {
            return $criteria;
        }
        $query = new PhysicalPerson2Query();
        if (null !== $modelAlias) {
    ...
    /**
     * Filters the query to target only PhysicalPerson2 objects.
     */
    public function preSelect(PropelPDO $con)
    {
        $this->addUsingAlias(ContactPeer::TYPE, ContactPeer::CLASSKEY_2);
    }
     ...
     * Having the PhysicalPerson2 class.
