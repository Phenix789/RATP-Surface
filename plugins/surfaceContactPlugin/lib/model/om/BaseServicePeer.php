...
/**
 * Base static class for performing query and update operations on the 'sfc_abk_service' table.
 *
 * 
 *
...
abstract class BaseServicePeer {
    ...
    const TABLE_NAME = 'sfc_abk_service';
    ...
    const ID = 'sfc_abk_service.ID';

    /** the column name for the SHORT_NAME field */
    const SHORT_NAME = 'sfc_abk_service.SHORT_NAME';

    /** the column name for the LONG_NAME field */
    const LONG_NAME = 'sfc_abk_service.LONG_NAME';

    /** the column name for the NAME_SPACE field */
    const NAME_SPACE = 'sfc_abk_service.NAME_SPACE';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'ShortName', 'LongName', 'NameSpace', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'shortName', 'longName', 'nameSpace', ),
        BasePeer::TYPE_COLNAME => array (self::ID, self::SHORT_NAME, self::LONG_NAME, self::NAME_SPACE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'SHORT_NAME', 'LONG_NAME', 'NAME_SPACE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'short_name', 'long_name', 'name_space', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ShortName' => 1, 'LongName' => 2, 'NameSpace' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'shortName' => 1, 'longName' => 2, 'nameSpace' => 3, ),
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::SHORT_NAME => 1, self::LONG_NAME => 2, self::NAME_SPACE => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'SHORT_NAME' => 1, 'LONG_NAME' => 2, 'NAME_SPACE' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'short_name' => 1, 'long_name' => 2, 'name_space' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ServicePeer::SHORT_NAME);
			$criteria->addSelectColumn(ServicePeer::LONG_NAME);
			$criteria->addSelectColumn(ServicePeer::NAME_SPACE);
		} else {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to sfc_abk_service
    ...
    /**
     * Deletes all rows from the sfc_abk_service table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
	...
	public static function doSelectPK(Criteria $criteria = null, $con = null) {
		return ServicePeer::doSelectFieldValues(ServicePeer::ID, $criteria, true, $con);
	}
  ...
  public static function doSelectFieldValues($field, $criteria = null, $distinct = false, $con = null) {
      ...
      $column = ServicePeer::getTableMap()->getColumn($field);
      $criteria->clearSelectColumns();
      $criteria->addSelectColumn($field);
      $stmt = ServicePeer::doSelectStmt($criteria, $con);
      $fields = array();
	 ...
	 *
	 */
	public static function getMetadata($info = null, $default = null, $class = 'Service') {
		if(!ServicePeer::$_metadata) {
			...
			ServicePeer::$_metadata = array_merge($default_metadata, $metadata);
		}
		if($info) {
			return get($info, ServicePeer::$_metadata, $default);
		}
		return ServicePeer::$_metadata;
	}
} // BaseServicePeer
