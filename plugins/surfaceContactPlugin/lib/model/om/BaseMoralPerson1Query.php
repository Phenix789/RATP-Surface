 ...
 */
class BaseMoralPerson1Query extends MoralPersonQuery {

    /**
     * Returns a new MoralPerson1Query object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return MoralPerson1Query
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof MoralPerson1Query) {
            return $criteria;
        }
        $query = new MoralPerson1Query();
        if (null !== $modelAlias) {
    ...
    /**
     * Filters the query to target only MoralPerson1 objects.
     */
    public function preSelect(PropelPDO $con)
    {
        $this->addUsingAlias(ContactPeer::TYPE, ContactPeer::CLASSKEY_101);
    }
