...
/**
 * Base class that represents a row from the 'sfc_abk_civility' table.
 *
 * 
 *
 * @package    propel.generator.plugins.surfaceContactPlugin.lib.model.om
 */
abstract class BaseCivility extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'CivilityPeer';
     ...
     * @return   Civility The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CivilityPeer::ID;
        }
    ...
    public function setShortName($v)
    {
        ...
        if ($this->short_name !== $v) {
            $this->short_name = $v;
            $this->modifiedColumns[] = CivilityPeer::SHORT_NAME;
        }
    ...
    public function setLongName($v)
    {
        ...
        if ($this->long_name !== $v) {
            $this->long_name = $v;
            $this->modifiedColumns[] = CivilityPeer::LONG_NAME;
        }
    ...
    public function setGenre($v)
    {
        ...
        if ($this->genre !== $v) {
            $this->genre = $v;
            $this->modifiedColumns[] = CivilityPeer::GENRE;
        }
    ...
    public function setNameSpace($v)
    {
        ...
        if ($this->name_space !== $v) {
            $this->name_space = $v;
            $this->modifiedColumns[] = CivilityPeer::NAME_SPACE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->genre = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            ...
            return $startcol + 5; // 5 = CivilityPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Civility object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CivilityPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseCivility:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
        ...
        try {
            $deleteQuery = CivilityQuery::create()
    ...
    foreach (sfMixer::getCallables('BaseCivility:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCivility:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CivilityPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    foreach (sfMixer::getCallables('BaseCivility:save:post') as $callable)
    {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {				
				$stmt = $con->query('SELECT sfc_abk_civility_SEQ.nextval FROM dual');
				$row = $stmt->fetch(PDO::FETCH_NUM);
				$this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(CivilityPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(CivilityPeer::SHORT_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'SHORT_NAME';
        }
        if ($this->isColumnModified(CivilityPeer::LONG_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'LONG_NAME';
        }
        if ($this->isColumnModified(CivilityPeer::GENRE)) {
            $modifiedColumns[':p' . $index++]  = 'GENRE';
        }
        if ($this->isColumnModified(CivilityPeer::NAME_SPACE)) {
            $modifiedColumns[':p' . $index++]  = 'NAME_SPACE';
        }

        $sql = sprintf(
            'INSERT INTO sfc_abk_civility (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CivilityPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CivilityPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Civility'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Civility'][$this->getPrimaryKey()] = true;
        $keys = CivilityPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CivilityPeer::ID)) $criteria->add(CivilityPeer::ID, $this->id);
        if ($this->isColumnModified(CivilityPeer::SHORT_NAME)) $criteria->add(CivilityPeer::SHORT_NAME, $this->short_name);
        if ($this->isColumnModified(CivilityPeer::LONG_NAME)) $criteria->add(CivilityPeer::LONG_NAME, $this->long_name);
        if ($this->isColumnModified(CivilityPeer::GENRE)) $criteria->add(CivilityPeer::GENRE, $this->genre);
        if ($this->isColumnModified(CivilityPeer::NAME_SPACE)) $criteria->add(CivilityPeer::NAME_SPACE, $this->name_space);
    ...
    {
        $criteria = new Criteria(CivilityPeer::DATABASE_NAME);
        $criteria->add(CivilityPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of Civility (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 Civility Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Civility is new, it will return
    ...
    public function setContacts(PropelCollection $contacts, PropelPDO $con = null)
    {
        ...
        foreach ($this->contactsScheduledForDeletion as $contactRemoved) {
            $contactRemoved->setCivility(null);
        }
     ...
     * Otherwise if this Civility is new, it will return
     * an empty collection; or if this Civility has previously
     * been saved, it will retrieve related Contacts from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Civility.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Contact[] List of Contact objects
     */
    public function getContactsJoinService($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ContactQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(CivilityPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    */
  try {
    if (!$callable = sfMixer::getCallable('BaseCivility:'.$name))
    {
      throw new sfException(sprintf('Call to undefined method BaseCivility::%s', $name));
    }
  ...
  */
  ...
  public function exportTo($parser, $includeLazyLoadColumns = true) {
	...
	public function getMetadata($info = null, $default = null) {
		return CivilityPeer::getMetadata($info, $default, get_class($this));
	}
