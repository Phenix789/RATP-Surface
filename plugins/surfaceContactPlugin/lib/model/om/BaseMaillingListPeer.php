...
abstract class BaseMaillingListPeer {
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += MaillingListPeer::doOnDeleteCascade(new Criteria(MaillingListPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += MaillingListPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = MaillingListPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {
            ...
            $criteria->add(MaillingListContactPeer::MAILLING_LIST_ID, $obj->getId());
