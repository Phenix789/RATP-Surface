...
/**
 * Base static class for performing query and update operations on the 'sfc_abk_group' table.
 *
 * 
 *
...
abstract class BaseGroupPeer {
    ...
    const TABLE_NAME = 'sfc_abk_group';
    ...
    const ID = 'sfc_abk_group.ID';

    /** the column name for the NAME field */
    const NAME = 'sfc_abk_group.NAME';

    /** the column name for the CODE_NAME field */
    const CODE_NAME = 'sfc_abk_group.CODE_NAME';

    /** the column name for the COMMENT field */
    const COMMENT = 'sfc_abk_group.COMMENT';

    /** the column name for the NAME_SPACE field */
    const NAME_SPACE = 'sfc_abk_group.NAME_SPACE';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'CodeName', 'Comment', 'NameSpace', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'codeName', 'comment', 'nameSpace', ),
        BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::CODE_NAME, self::COMMENT, self::NAME_SPACE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'CODE_NAME', 'COMMENT', 'NAME_SPACE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'code_name', 'comment', 'name_space', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'CodeName' => 2, 'Comment' => 3, 'NameSpace' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'codeName' => 2, 'comment' => 3, 'nameSpace' => 4, ),
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::CODE_NAME => 2, self::COMMENT => 3, self::NAME_SPACE => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'CODE_NAME' => 2, 'COMMENT' => 3, 'NAME_SPACE' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'code_name' => 2, 'comment' => 3, 'name_space' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(GroupPeer::CODE_NAME);
			$criteria->addSelectColumn(GroupPeer::COMMENT);
			$criteria->addSelectColumn(GroupPeer::NAME_SPACE);
		} else {
			$criteria->addSelectColumn($alias.'.ID');
			$criteria->addSelectColumn($alias.'.NAME');
			$criteria->addSelectColumn($alias.'.CODE_NAME');
    ...
    /**
     * Method to invalidate the instance pool of all tables related to sfc_abk_group
    ...
    /**
     * Deletes all rows from the sfc_abk_group table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(ContactGroupPeer::GROUP_ID, $obj->getId());
	...
	public static function doSelectPK(Criteria $criteria = null, $con = null) {
		return GroupPeer::doSelectFieldValues(GroupPeer::ID, $criteria, true, $con);
	}
  ...
  public static function doSelectFieldValues($field, $criteria = null, $distinct = false, $con = null) {
      ...
      $column = GroupPeer::getTableMap()->getColumn($field);
      $criteria->clearSelectColumns();
      $criteria->addSelectColumn($field);
      $stmt = GroupPeer::doSelectStmt($criteria, $con);
      $fields = array();
	 ...
	 *
	 */
	public static function getMetadata($info = null, $default = null, $class = 'Group') {
		if(!GroupPeer::$_metadata) {
			...
			GroupPeer::$_metadata = array_merge($default_metadata, $metadata);
		}
		if($info) {
			return get($info, GroupPeer::$_metadata, $default);
		}
		return GroupPeer::$_metadata;
	}
} // BaseGroupPeer
