 ...
 */
class BasePhysicalPerson5Query extends PhysicalPersonQuery {

    /**
     * Returns a new PhysicalPerson5Query object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return PhysicalPerson5Query
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof PhysicalPerson5Query) {
            return $criteria;
        }
        $query = new PhysicalPerson5Query();
        if (null !== $modelAlias) {
    ...
    /**
     * Filters the query to target only PhysicalPerson5 objects.
     */
    public function preSelect(PropelPDO $con)
    {
        $this->addUsingAlias(ContactPeer::TYPE, ContactPeer::CLASSKEY_5);
    }
     ...
     * Having the PhysicalPerson5 class.
