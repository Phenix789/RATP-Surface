 ...
 */
class BasePhysicalPerson3Query extends PhysicalPersonQuery {

    /**
     * Returns a new PhysicalPerson3Query object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return PhysicalPerson3Query
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof PhysicalPerson3Query) {
            return $criteria;
        }
        $query = new PhysicalPerson3Query();
        if (null !== $modelAlias) {
    ...
    /**
     * Filters the query to target only PhysicalPerson3 objects.
     */
    public function preSelect(PropelPDO $con)
    {
        $this->addUsingAlias(ContactPeer::TYPE, ContactPeer::CLASSKEY_3);
    }
     ...
     * Having the PhysicalPerson3 class.
