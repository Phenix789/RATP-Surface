 ...
 */
class BaseMoralPerson2Query extends MoralPersonQuery {

    /**
     * Returns a new MoralPerson2Query object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return MoralPerson2Query
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof MoralPerson2Query) {
            return $criteria;
        }
        $query = new MoralPerson2Query();
        if (null !== $modelAlias) {
    ...
    /**
     * Filters the query to target only MoralPerson2 objects.
     */
    public function preSelect(PropelPDO $con)
    {
        $this->addUsingAlias(ContactPeer::TYPE, ContactPeer::CLASSKEY_102);
    }
