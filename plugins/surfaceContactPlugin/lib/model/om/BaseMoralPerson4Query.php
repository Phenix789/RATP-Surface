 ...
 */
class BaseMoralPerson4Query extends MoralPersonQuery {

    /**
     * Returns a new MoralPerson4Query object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return MoralPerson4Query
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof MoralPerson4Query) {
            return $criteria;
        }
        $query = new MoralPerson4Query();
        if (null !== $modelAlias) {
    ...
    /**
     * Filters the query to target only MoralPerson4 objects.
     */
    public function preSelect(PropelPDO $con)
    {
        $this->addUsingAlias(ContactPeer::TYPE, ContactPeer::CLASSKEY_104);
    }
