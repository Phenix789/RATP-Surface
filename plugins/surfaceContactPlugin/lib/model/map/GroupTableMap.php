...
/**
 * This class defines the structure of the 'sfc_abk_group' table.
 *
 *
 *
...
class GroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'plugins.surfaceContactPlugin.lib.model.map.GroupTableMap';
    ...
    {
        $this->addRelation('ContactGroup', 'ContactGroup', RelationMap::ONE_TO_MANY, array('id' => 'group_id', ), 'CASCADE', null, 'ContactGroups');
    } // buildRelations()
