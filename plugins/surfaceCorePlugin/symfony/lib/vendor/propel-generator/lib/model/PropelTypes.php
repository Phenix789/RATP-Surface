...
class PropelTypes
{
    ...
    private static $TEXT_TYPES = array(
        self::CHAR, self::VARCHAR, self::LONGVARCHAR, self::CLOB, self::DATE, self::TIME, self::TIMESTAMP, self::BU_DATE, self::BU_TIMESTAMP, self::GEOMETRY, self::MULTIPOLYGON
    );
    ...
    const NUMERIC_NATIVE_TYPE = "double"; //Was string
    const DECIMAL_NATIVE_TYPE = "double"; //Was string
    const TINYINT_NATIVE_TYPE = "int";
    const SMALLINT_NATIVE_TYPE = "int";
    const INTEGER_NATIVE_TYPE = "int";
    const BIGINT_NATIVE_TYPE = "int"; //Was string
    ...
    const GEOMETRY_NATIVE_TYPE = "Geometry";
    const MULTIPOLYGON_NATIVE_TYPE = "Geometry";
    ...
    private static $propelToPHPNativeMap = array(
            ...
            self::MULTIPOLYGON => self::MULTIPOLYGON_NATIVE_TYPE,
    );
    ...
    private static $propelTypeToCreoleTypeMap = array(
            ...
            self::MULTIPOLYGON => self::MULTIPOLYGON,
    ...
    private static $propelTypeToPDOTypeMap = array(
            ...
            self::MULTIPOLYGON => PDO::PARAM_STR,
            // These are pre-epoch dates, which we need to map to String type
            // since they cannot be properly handled using strtotime() -- or even numeric
            // timestamps on Windows.
