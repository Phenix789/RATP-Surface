...
include_once dirname(__DIR__).'/config/GeneratorConfig.php';
include_once dirname(__DIR__).'/model/AppData.php';
include_once dirname(__DIR__).'/model/Database.php';
include_once dirname(__DIR__).'/builder/util/XmlToAppData.php';
include_once dirname(__DIR__).'/util/PropelSchemaValidator.php';
