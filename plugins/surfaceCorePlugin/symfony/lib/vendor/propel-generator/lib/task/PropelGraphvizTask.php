...
require_once dirname(__DIR__).'/task/AbstractPropelDataModelTask.php';
require_once dirname(__DIR__).'/model/AppData.php';
require_once dirname(__DIR__).'/util/PropelDotGenerator.php';
