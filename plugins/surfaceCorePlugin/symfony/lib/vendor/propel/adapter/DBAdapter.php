...
abstract class DBAdapter
{
    ...
    public function bindValue(PDOStatement $stmt, $parameter, $value, ColumnMap $cMap, $position = null)
    {
		...
		require_once dirname(dirname(__DIR__)).'/propel-generator/lib/model/PropelTypes.php';
		$phpType = PropelTypes::getPhpNative($cMap->getType());
		if(!PropelTypes::isPhpObjectType($phpType)){
