...
class Propel
{
    ...
    public static function initConnection($conparams, $name, $defaultClass = Propel::CLASS_PROPEL_PDO)
    {
		...
		$con->setAttribute(PropelPDO::ATTR_EMULATE_PREPARES, false); //PATCH FOR PHP 5.3.10-1ubuntu3.4 : Boolean problem with Postgres: to delete as soon as it's corrected
