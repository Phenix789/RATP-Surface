...
class sfWebBrowser
{
   ...
   * @return sfWebBrowser The current browser object
   */  
  public function call($uri, $method = 'GET', $parameters = array(), $headers = array(), $changeStack = true, $pass = 0)
  {
    ...
    if ($pass < 10) {
      ...
      {
        $pass ++;
        $this->call($browser->getResponseHeader('Location'), 'GET', array(), $headers, true, $pass);
      }
    } else {
