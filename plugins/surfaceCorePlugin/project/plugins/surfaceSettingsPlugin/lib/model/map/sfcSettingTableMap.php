...
/**
 * This class defines the structure of the 'sfc_setting' table.
 *
 *
 *
 ...
 *
 * @package    propel.generator.plugins.surfaceSettingsPlugin.lib.model.map
 */
class sfcSettingTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'plugins.surfaceSettingsPlugin.lib.model.map.sfcSettingTableMap';
    ...
    {
        // attributes
        $this->setName('sfc_setting');
        $this->setPhpName('sfcSetting');
