 ...
 * @method     sfGuardUserPermissionQuery orderByEntityId($order = Criteria::ASC) Order by the entity_id column
 *
 ...
 * @method     sfGuardUserPermissionQuery groupByEntityId() Group by the entity_id column
 *
 ...
 *
 * @method     sfGuardUserPermissionQuery leftJoinsfGuardEntity($relationAlias = null) Adds a LEFT JOIN clause to the query using the sfGuardEntity relation
 * @method     sfGuardUserPermissionQuery rightJoinsfGuardEntity($relationAlias = null) Adds a RIGHT JOIN clause to the query using the sfGuardEntity relation
 * @method     sfGuardUserPermissionQuery innerJoinsfGuardEntity($relationAlias = null) Adds a INNER JOIN clause to the query using the sfGuardEntity relation
 *
 ...
 * @method     sfGuardUserPermission findOneByEntityId(int $entity_id) Return the first sfGuardUserPermission filtered by the entity_id column
 *
 ...
 * @method     array findByEntityId(int $entity_id) Return sfGuardUserPermission objects filtered by the entity_id column
 *
...
abstract class BasesfGuardUserPermissionQuery extends ModelCriteria
{
     ...
     * @param array $key Primary key to use for the query 
                         A Primary key composition: [$user_id, $permission_id, $entity_id]
    ...
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = sfGuardUserPermissionPeer::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1], (string) $key[2]))))) && !$this->formatter) {
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            sfGuardUserPermissionPeer::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1], (string) $key[2])));
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(sfGuardUserPermissionPeer::ENTITY_ID, $key[2], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            ...
            $cton0->addAnd($cton1);
            $cton2 = $this->getNewCriterion(sfGuardUserPermissionPeer::ENTITY_ID, $key[2], Criteria::EQUAL);
            $cton0->addAnd($cton2);
            $this->addOr($cton0);
        }
    ...
    public function filterByEntityId($entityId = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(sfGuardUserPermissionPeer::ENTITY_ID, $entityId, $comparison);
    }
    ...
    public function filterBysfGuardEntity($sfGuardEntity, $comparison = null)
    {
        if ($sfGuardEntity instanceof sfGuardEntity) {
            return $this
                ->addUsingAlias(sfGuardUserPermissionPeer::ENTITY_ID, $sfGuardEntity->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(sfGuardUserPermissionPeer::ENTITY_ID, $sfGuardEntity->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function prune($sfGuardUserPermission = null)
    {
        if ($sfGuardUserPermission) {
            ...
            $this->addCond('pruneCond2', $this->getAliasedColName(sfGuardUserPermissionPeer::ENTITY_ID), $sfGuardUserPermission->getEntityId(), Criteria::NOT_EQUAL);
