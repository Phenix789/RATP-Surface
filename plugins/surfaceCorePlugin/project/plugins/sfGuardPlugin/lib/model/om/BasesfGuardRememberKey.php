 ...
 */
abstract class BasesfGuardRememberKey extends BaseObject 
{
    ...
    if (!$this->isSkipEdited() && !$this->isColumnModified(sfGuardRememberKeyPeer::CREATED_AT))
    {
  ...
  try {
    ...
    {
      throw new sfException(sprintf('Call to undefined method BasesfGuardRememberKey::%s', $name));
    }
  ...
  */
  ...
  {
    return (string) $this->getRememberKey();
  }
  ...
  public function exportTo($parser, $includeLazyLoadColumns = true) {
	...
	public function getMetadata($info = null, $default = null) {
		return sfGuardRememberKeyPeer::getMetadata($info, $default, get_class($this));
	}
