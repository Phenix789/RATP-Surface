...
abstract class BasesfGuardGroupPeer {
	...
	public static function doSelectPK(Criteria $criteria = null, $con = null) {
		return sfGuardGroupPeer::doSelectFieldValues(sfGuardGroupPeer::ID, $criteria, true, $con);
	}
  ...
  public static function doSelectFieldValues($field, $criteria = null, $distinct = false, $con = null) {
      ...
      $column = sfGuardGroupPeer::getTableMap()->getColumn($field);
      $criteria->clearSelectColumns();
      $criteria->addSelectColumn($field);
      $stmt = sfGuardGroupPeer::doSelectStmt($criteria, $con);
      $fields = array();
	 ...
	 *
	 */
	public static function getMetadata($info = null, $default = null, $class = 'sfGuardGroup') {
		if(!sfGuardGroupPeer::$_metadata) {
			...
			sfGuardGroupPeer::$_metadata = array_merge($default_metadata, $metadata);
		}
		if($info) {
			return get($info, sfGuardGroupPeer::$_metadata, $default);
		}
		return sfGuardGroupPeer::$_metadata;
	}
