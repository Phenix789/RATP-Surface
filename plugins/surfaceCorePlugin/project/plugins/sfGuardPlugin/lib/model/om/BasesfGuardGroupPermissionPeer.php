...
abstract class BasesfGuardGroupPermissionPeer {
    ...
    const ENTITY_ID = 'sf_guard_group_permission.ENTITY_ID';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('GroupId', 'PermissionId', 'EntityId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('groupId', 'permissionId', 'entityId', ),
        BasePeer::TYPE_COLNAME => array (self::GROUP_ID, self::PERMISSION_ID, self::ENTITY_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('GROUP_ID', 'PERMISSION_ID', 'ENTITY_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('group_id', 'permission_id', 'entity_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('GroupId' => 0, 'PermissionId' => 1, 'EntityId' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('groupId' => 0, 'permissionId' => 1, 'entityId' => 2, ),
        BasePeer::TYPE_COLNAME => array (self::GROUP_ID => 0, self::PERMISSION_ID => 1, self::ENTITY_ID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('GROUP_ID' => 0, 'PERMISSION_ID' => 1, 'ENTITY_ID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('group_id' => 0, 'permission_id' => 1, 'entity_id' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(sfGuardGroupPermissionPeer::ENTITY_ID);
		} else {
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = serialize(array((string) $obj->getGroupId(), (string) $obj->getPermissionId(), (string) $obj->getEntityId()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof sfGuardGroupPermission) {
                $key = serialize(array((string) $value->getGroupId(), (string) $value->getPermissionId(), (string) $value->getEntityId()));
    ...
    /**
     * Returns the number of rows matching criteria, joining the related sfGuardEntity table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinsfGuardEntity(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
        ...
        $criteria->addJoin(sfGuardGroupPermissionPeer::ENTITY_ID, sfGuardEntityPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of sfGuardGroupPermission objects pre-filled with their sfGuardEntity objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of sfGuardGroupPermission objects.
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinsfGuardEntity(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = sfGuardEntityPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = sfGuardEntityPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    $obj2 = new $cls();
                    $obj2->hydrate($row, $startcol);
                    sfGuardEntityPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (sfGuardGroupPermission) to $obj2 (sfGuardEntity)
                $obj2->addsfGuardGroupPermission($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        sfGuardEntityPeer::addSelectColumns($criteria);
        $startcol5 = $startcol4 + sfGuardEntityPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined sfGuardEntity rows

            $key4 = sfGuardEntityPeer::getPrimaryKeyHashFromRow($row, $startcol4);
            if ($key4 !== null) {
                $obj4 = sfGuardEntityPeer::getInstanceFromPool($key4);
                if (!$obj4) {
                    ...
                    sfGuardEntityPeer::addInstanceToPool($obj4, $key4);
                } // if obj4 loaded

                // Add the $obj1 (sfGuardGroupPermission) to the collection in $obj4 (sfGuardEntity)
                $obj4->addsfGuardGroupPermission($obj1);
            } // if joined row not null
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptsfGuardEntity(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
    ...
    public static function doSelectJoinAllExceptsfGuardGroup(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        sfGuardEntityPeer::addSelectColumns($criteria);
        $startcol4 = $startcol3 + sfGuardEntityPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = sfGuardGroupPermissionPeer::getInstanceFromPool($key1))) {
                ...
                $key3 = sfGuardEntityPeer::getPrimaryKeyHashFromRow($row, $startcol3);
                if ($key3 !== null) {
                    $obj3 = sfGuardEntityPeer::getInstanceFromPool($key3);
                    if (!$obj3) {
                    ...
                    $obj3 = new $cls();
                    $obj3->hydrate($row, $startcol3);
                    sfGuardEntityPeer::addInstanceToPool($obj3, $key3);
                } // if $obj3 already loaded

                // Add the $obj1 (sfGuardGroupPermission) to the collection in $obj3 (sfGuardEntity)
                $obj3->addsfGuardGroupPermission($obj1);
    ...
    /**
     * Selects a collection of sfGuardGroupPermission objects pre-filled with all related objects except sfGuardEntity.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptsfGuardEntity(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
    ...
    foreach (sfMixer::getCallables('BasesfGuardGroupPermissionPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(sfGuardGroupPermissionPeer::ENTITY_ID);
            $value = $criteria->remove(sfGuardGroupPermissionPeer::ENTITY_ID);
            if ($value) {
                $selectCriteria->add(sfGuardGroupPermissionPeer::ENTITY_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(sfGuardGroupPermissionPeer::TABLE_NAME);
            }
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                ...
                $criterion->addAnd($criteria->getNewCriterion(sfGuardGroupPermissionPeer::ENTITY_ID, $value[2]));
     ...
     * @return   sfGuardGroupPermission
     */
    public static function retrieveByPK($group_id, $permission_id, $entity_id, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $group_id, (string) $permission_id, (string) $entity_id));
        ...
        $criteria->add(sfGuardGroupPermissionPeer::ENTITY_ID, $entity_id);
  ...
  public static function doSelectFieldValues($field, $criteria = null, $distinct = false, $con = null) {
      ...
      $column = sfGuardGroupPermissionPeer::getTableMap()->getColumn($field);
      $criteria->clearSelectColumns();
      $criteria->addSelectColumn($field);
      $stmt = sfGuardGroupPermissionPeer::doSelectStmt($criteria, $con);
      $fields = array();
	 ...
	 *
	 */
	public static function getMetadata($info = null, $default = null, $class = 'sfGuardGroupPermission') {
		if(!sfGuardGroupPermissionPeer::$_metadata) {
			...
			sfGuardGroupPermissionPeer::$_metadata = array_merge($default_metadata, $metadata);
		}
		if($info) {
			return get($info, sfGuardGroupPermissionPeer::$_metadata, $default);
		}
		return sfGuardGroupPermissionPeer::$_metadata;
	}
