...
abstract class BasesfGuardPermissionPeer {
	...
	public static function doSelectPK(Criteria $criteria = null, $con = null) {
		return sfGuardPermissionPeer::doSelectFieldValues(sfGuardPermissionPeer::ID, $criteria, true, $con);
	}
  ...
  public static function doSelectFieldValues($field, $criteria = null, $distinct = false, $con = null) {
      ...
      $column = sfGuardPermissionPeer::getTableMap()->getColumn($field);
      $criteria->clearSelectColumns();
      $criteria->addSelectColumn($field);
      $stmt = sfGuardPermissionPeer::doSelectStmt($criteria, $con);
      $fields = array();
	 ...
	 *
	 */
	public static function getMetadata($info = null, $default = null, $class = 'sfGuardPermission') {
		if(!sfGuardPermissionPeer::$_metadata) {
			...
			sfGuardPermissionPeer::$_metadata = array_merge($default_metadata, $metadata);
		}
		if($info) {
			return get($info, sfGuardPermissionPeer::$_metadata, $default);
		}
		return sfGuardPermissionPeer::$_metadata;
	}
