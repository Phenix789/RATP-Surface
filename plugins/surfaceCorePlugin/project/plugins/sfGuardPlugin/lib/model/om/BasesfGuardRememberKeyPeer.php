...
abstract class BasesfGuardRememberKeyPeer {
  ...
  public static function doSelectFieldValues($field, $criteria = null, $distinct = false, $con = null) {
      ...
      $column = sfGuardRememberKeyPeer::getTableMap()->getColumn($field);
      $criteria->clearSelectColumns();
      $criteria->addSelectColumn($field);
      $stmt = sfGuardRememberKeyPeer::doSelectStmt($criteria, $con);
      $fields = array();
	 ...
	 *
	 */
	public static function getMetadata($info = null, $default = null, $class = 'sfGuardRememberKey') {
		if(!sfGuardRememberKeyPeer::$_metadata) {
			...
			sfGuardRememberKeyPeer::$_metadata = array_merge($default_metadata, $metadata);
		}
		if($info) {
			return get($info, sfGuardRememberKeyPeer::$_metadata, $default);
		}
		return sfGuardRememberKeyPeer::$_metadata;
	}
