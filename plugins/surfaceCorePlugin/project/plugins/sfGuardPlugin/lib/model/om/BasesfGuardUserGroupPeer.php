...
abstract class BasesfGuardUserGroupPeer {
  ...
  public static function doSelectFieldValues($field, $criteria = null, $distinct = false, $con = null) {
      ...
      $column = sfGuardUserGroupPeer::getTableMap()->getColumn($field);
      $criteria->clearSelectColumns();
      $criteria->addSelectColumn($field);
      $stmt = sfGuardUserGroupPeer::doSelectStmt($criteria, $con);
      $fields = array();
	 ...
	 *
	 */
	public static function getMetadata($info = null, $default = null, $class = 'sfGuardUserGroup') {
		if(!sfGuardUserGroupPeer::$_metadata) {
			...
			sfGuardUserGroupPeer::$_metadata = array_merge($default_metadata, $metadata);
		}
		if($info) {
			return get($info, sfGuardUserGroupPeer::$_metadata, $default);
		}
		return sfGuardUserGroupPeer::$_metadata;
	}
