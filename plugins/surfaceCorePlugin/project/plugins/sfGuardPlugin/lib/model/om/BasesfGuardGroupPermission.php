 ...
 */
abstract class BasesfGuardGroupPermission extends BaseObject 
{
    ...
    public function setEntityId($v)
    {
        ...
        if ($this->entity_id !== $v) {
            $this->entity_id = $v;
            $this->modifiedColumns[] = sfGuardGroupPermissionPeer::ENTITY_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = sfGuardGroupPermissionPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(sfGuardGroupPermissionPeer::ENTITY_ID)) $criteria->add(sfGuardGroupPermissionPeer::ENTITY_ID, $this->entity_id);
    ...
    public function buildPkeyCriteria()
    {
        ...
        $criteria->add(sfGuardGroupPermissionPeer::ENTITY_ID, $this->entity_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getGroupId()) && (null === $this->getPermissionId()) && (null === $this->getEntityId());
    }
    ...
    public function getsfGuardEntity(PropelPDO $con = null)
    {
        if ($this->asfGuardEntity === null && ($this->entity_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->asfGuardEntity->addsfGuardGroupPermissions($this);
             */
        }
  ...
  try {
    ...
    {
      throw new sfException(sprintf('Call to undefined method BasesfGuardGroupPermission::%s', $name));
    }
  ...
  public function exportTo($parser, $includeLazyLoadColumns = true) {
	...
	public function getMetadata($info = null, $default = null) {
		return sfGuardGroupPermissionPeer::getMetadata($info, $default, get_class($this));
	}
