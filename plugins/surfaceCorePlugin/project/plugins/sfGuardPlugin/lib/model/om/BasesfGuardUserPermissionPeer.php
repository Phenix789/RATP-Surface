...
abstract class BasesfGuardUserPermissionPeer {
    ...
    const ENTITY_ID = 'sf_guard_user_permission.ENTITY_ID';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('UserId', 'PermissionId', 'EntityId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'permissionId', 'entityId', ),
        BasePeer::TYPE_COLNAME => array (self::USER_ID, self::PERMISSION_ID, self::ENTITY_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER_ID', 'PERMISSION_ID', 'ENTITY_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('user_id', 'permission_id', 'entity_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'PermissionId' => 1, 'EntityId' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'permissionId' => 1, 'entityId' => 2, ),
        BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, self::PERMISSION_ID => 1, self::ENTITY_ID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER_ID' => 0, 'PERMISSION_ID' => 1, 'ENTITY_ID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'permission_id' => 1, 'entity_id' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(sfGuardUserPermissionPeer::ENTITY_ID);
		} else {
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = serialize(array((string) $obj->getUserId(), (string) $obj->getPermissionId(), (string) $obj->getEntityId()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof sfGuardUserPermission) {
                $key = serialize(array((string) $value->getUserId(), (string) $value->getPermissionId(), (string) $value->getEntityId()));
    ...
    public static function doCountJoinsfGuardEntity(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(sfGuardUserPermissionPeer::ENTITY_ID, sfGuardEntityPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of sfGuardUserPermission objects pre-filled with their sfGuardEntity objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of sfGuardUserPermission objects.
    ...
    public static function doSelectJoinsfGuardEntity(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (sfGuardUserPermission) to $obj2 (sfGuardEntity)
                $obj2->addsfGuardUserPermission($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (sfGuardUserPermission) to the collection in $obj4 (sfGuardEntity)
                $obj4->addsfGuardUserPermission($obj1);
            } // if joined row not null
    ...
    public static function doSelectJoinAllExceptsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = sfGuardUserPermissionPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (sfGuardUserPermission) to the collection in $obj3 (sfGuardEntity)
                $obj3->addsfGuardUserPermission($obj1);
    ...
    /**
     * Selects a collection of sfGuardUserPermission objects pre-filled with all related objects except sfGuardEntity.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BasesfGuardUserPermissionPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(sfGuardUserPermissionPeer::ENTITY_ID);
            $value = $criteria->remove(sfGuardUserPermissionPeer::ENTITY_ID);
            if ($value) {
                $selectCriteria->add(sfGuardUserPermissionPeer::ENTITY_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(sfGuardUserPermissionPeer::TABLE_NAME);
            }
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                ...
                $criterion->addAnd($criteria->getNewCriterion(sfGuardUserPermissionPeer::ENTITY_ID, $value[2]));
     ...
     * @return   sfGuardUserPermission
     */
    public static function retrieveByPK($user_id, $permission_id, $entity_id, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $user_id, (string) $permission_id, (string) $entity_id));
        ...
        $criteria->add(sfGuardUserPermissionPeer::ENTITY_ID, $entity_id);
  ...
  public static function doSelectFieldValues($field, $criteria = null, $distinct = false, $con = null) {
      ...
      $column = sfGuardUserPermissionPeer::getTableMap()->getColumn($field);
      $criteria->clearSelectColumns();
      $criteria->addSelectColumn($field);
      $stmt = sfGuardUserPermissionPeer::doSelectStmt($criteria, $con);
      $fields = array();
	 ...
	 *
	 */
	public static function getMetadata($info = null, $default = null, $class = 'sfGuardUserPermission') {
		if(!sfGuardUserPermissionPeer::$_metadata) {
			...
			sfGuardUserPermissionPeer::$_metadata = array_merge($default_metadata, $metadata);
		}
		if($info) {
			return get($info, sfGuardUserPermissionPeer::$_metadata, $default);
		}
		return sfGuardUserPermissionPeer::$_metadata;
	}
