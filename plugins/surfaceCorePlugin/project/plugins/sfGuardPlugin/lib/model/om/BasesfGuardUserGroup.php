 ...
 */
abstract class BasesfGuardUserGroup extends BaseObject 
{
  ...
  try {
    ...
    {
      throw new sfException(sprintf('Call to undefined method BasesfGuardUserGroup::%s', $name));
    }
  ...
  public function exportTo($parser, $includeLazyLoadColumns = true) {
	...
	public function getMetadata($info = null, $default = null) {
		return sfGuardUserGroupPeer::getMetadata($info, $default, get_class($this));
	}
