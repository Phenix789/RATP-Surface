 ...
 */
abstract class BasesfGuardUserPermission extends BaseObject 
{
    ...
    public function setEntityId($v)
    {
        ...
        if ($this->entity_id !== $v) {
            $this->entity_id = $v;
            $this->modifiedColumns[] = sfGuardUserPermissionPeer::ENTITY_ID;
        }

        if ($this->asfGuardEntity !== null && $this->asfGuardEntity->getId() !== $v) {
            $this->asfGuardEntity = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->entity_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = sfGuardUserPermissionPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->asfGuardEntity !== null && $this->entity_id !== $this->asfGuardEntity->getId()) {
            $this->asfGuardEntity = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->asfGuardEntity !== null) {
                if ($this->asfGuardEntity->isModified() || $this->asfGuardEntity->isNew()) {
                    $affectedRows += $this->asfGuardEntity->save($con);
                }
                $this->setsfGuardEntity($this->asfGuardEntity);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(sfGuardUserPermissionPeer::ENTITY_ID)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->asfGuardEntity !== null) {
                if (!$this->asfGuardEntity->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->asfGuardEntity->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->asfGuardEntity) {
                $result['sfGuardEntity'] = $this->asfGuardEntity->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(sfGuardUserPermissionPeer::ENTITY_ID)) $criteria->add(sfGuardUserPermissionPeer::ENTITY_ID, $this->entity_id);
    ...
    public function buildPkeyCriteria()
    {
        ...
        $criteria->add(sfGuardUserPermissionPeer::ENTITY_ID, $this->entity_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getUserId()) && (null === $this->getPermissionId()) && (null === $this->getEntityId());
    }
    ...
    /**
     * Declares an association between this object and a sfGuardEntity object.
     *
     * @param                  sfGuardEntity $v
     * @return                 sfGuardUserPermission The current object (for fluent API support)
     * @throws PropelException
     */
    public function setsfGuardEntity(sfGuardEntity $v = null)
    {
        if ($v === null) {
        ...
        $this->asfGuardEntity = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the sfGuardEntity object, it will not be re-added.
        if ($v !== null) {
            $v->addsfGuardUserPermission($this);
        }
    ...
    /**
     * Get the associated sfGuardEntity object
     *
     * @param      PropelPDO $con Optional Connection object.
     * @return                 sfGuardEntity The associated sfGuardEntity object.
     * @throws PropelException
     */
    public function getsfGuardEntity(PropelPDO $con = null)
    {
        if ($this->asfGuardEntity === null && ($this->entity_id !== null)) {
            $this->asfGuardEntity = sfGuardEntityQuery::create()->findPk($this->entity_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->asfGuardEntity->addsfGuardUserPermissions($this);
             */
        }

        return $this->asfGuardEntity;
    }
  ...
  try {
    ...
    {
      throw new sfException(sprintf('Call to undefined method BasesfGuardUserPermission::%s', $name));
    }
  ...
  public function exportTo($parser, $includeLazyLoadColumns = true) {
	...
	public function getMetadata($info = null, $default = null) {
		return sfGuardUserPermissionPeer::getMetadata($info, $default, get_class($this));
	}
