...
class sfGuardGroupPermissionTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignPrimaryKey('ENTITY_ID', 'EntityId', 'INTEGER' , 'sf_guard_entity', 'ID', true, null, null);
        // validators
    } // initialize()
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('sfGuardEntity', 'sfGuardEntity', RelationMap::MANY_TO_ONE, array('entity_id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
