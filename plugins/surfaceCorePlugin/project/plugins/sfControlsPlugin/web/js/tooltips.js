...
Tooltip.prototype = {
	...
	setOptions: function(options) {
		this.options = {
			backgroundColor: '#FFB', // Default background color
			borderColor: '#CC9', // Default border color
	...
	appear: function() {
		var elementContent = Builder.node("div", {className: "xboxcontent", style: "background-color:" + this.options.backgroundColor + 
		...
		elementContent.innerHTML = this.content;
