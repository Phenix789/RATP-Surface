...
/**
 * Base class that represents a row from the 'plugin_cart_item' table.
 *
 * 
 *
 * @package    propel.generator.plugins.surfaceCartPlugin.lib.model.om
 */
abstract class BaseCartItem extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'CartItemPeer';
     ...
     * @return   CartItem The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CartItemPeer::ID;
        }
    ...
    public function setCartId($v)
    {
        ...
        if ($this->cart_id !== $v) {
            $this->cart_id = $v;
            $this->modifiedColumns[] = CartItemPeer::CART_ID;
        }
    ...
    public function setObjectId($v)
    {
        ...
        if ($this->object_id !== $v) {
            $this->object_id = $v;
            $this->modifiedColumns[] = CartItemPeer::OBJECT_ID;
        }
    ...
    public function setObjectName($v)
    {
        ...
        if ($this->object_name !== $v) {
            $this->object_name = $v;
            $this->modifiedColumns[] = CartItemPeer::OBJECT_NAME;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CartItemPeer::CREATED_AT;
            }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = CartItemPeer::CREATED_BY;
        }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CartItemPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = CartItemPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->cart_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->object_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->object_name = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 8; // 8 = CartItemPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CartItem object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CartItemPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseCartItem:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
        ...
        try {
            $deleteQuery = CartItemQuery::create()
    ...
    foreach (sfMixer::getCallables('BaseCartItem:delete:post') as $callable)
    {
    ...
    if (!$this->isSkipEdited() && !$this->isColumnModified(CartItemPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
    }

    if (!$this->isSkipEdited() && !$this->isColumnModified(CartItemPeer::UPDATED_BY))
    {
    ...
    if (!$this->isSkipEdited() && !$this->isColumnModified(CartItemPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if (!$this->isSkipEdited() && !$this->isColumnModified(CartItemPeer::CREATED_BY))
    {
      $user_id = (sfContext::getInstance() && sfContext::getInstance()->getUser() && sfContext::getInstance()->getUser()->getGuardUser())? sfContext::getInstance()->getUser()->getGuardUser()->getId() : null;
    ...
    foreach (sfMixer::getCallables('BaseCartItem:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(CartItemPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(CartItemPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
    }
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CartItemPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    foreach (sfMixer::getCallables('BaseCartItem:save:post') as $callable)
    {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CartItemPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(CartItemPeer::CART_ID)) {
            $modifiedColumns[':p' . $index++]  = '`CART_ID`';
        }
        if ($this->isColumnModified(CartItemPeer::OBJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`OBJECT_ID`';
        }
        if ($this->isColumnModified(CartItemPeer::OBJECT_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`OBJECT_NAME`';
        }
        if ($this->isColumnModified(CartItemPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_AT`';
        }
        if ($this->isColumnModified(CartItemPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_BY`';
        }
        if ($this->isColumnModified(CartItemPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`UPDATED_AT`';
        }
        if ($this->isColumnModified(CartItemPeer::UPDATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`UPDATED_BY`';
        }

        $sql = sprintf(
            'INSERT INTO `plugin_cart_item` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CartItemPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CartItemPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $keys = CartItemPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCartId(),
            $keys[2] => $this->getObjectId(),
            $keys[3] => $this->getObjectName(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setObjectName($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CartItemPeer::ID)) $criteria->add(CartItemPeer::ID, $this->id);
        if ($this->isColumnModified(CartItemPeer::CART_ID)) $criteria->add(CartItemPeer::CART_ID, $this->cart_id);
        if ($this->isColumnModified(CartItemPeer::OBJECT_ID)) $criteria->add(CartItemPeer::OBJECT_ID, $this->object_id);
        if ($this->isColumnModified(CartItemPeer::OBJECT_NAME)) $criteria->add(CartItemPeer::OBJECT_NAME, $this->object_name);
        if ($this->isColumnModified(CartItemPeer::CREATED_AT)) $criteria->add(CartItemPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(CartItemPeer::CREATED_BY)) $criteria->add(CartItemPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(CartItemPeer::UPDATED_AT)) $criteria->add(CartItemPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(CartItemPeer::UPDATED_BY)) $criteria->add(CartItemPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(CartItemPeer::DATABASE_NAME);
        $criteria->add(CartItemPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of CartItem (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 CartItem Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a Cart object.
     *
     * @param                  Cart $v
     * @return                 CartItem The current object (for fluent API support)
     * @throws PropelException
     */
    public function setCart(Cart $v = null)
    {
        if ($v === null) {
            $this->setCartId(NULL);
        } else {
        ...
        // If this object has already been added to the Cart object, it will not be re-added.
        if ($v !== null) {
            $v->addCartItem($this);
        }
     ...
     * @return                 Cart The associated Cart object.
     * @throws PropelException
     */
    public function getCart(PropelPDO $con = null)
    {
    ...
    public function setsfGuardUserRelatedByCreatedBy(sfGuardUser $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCartItemRelatedByCreatedBy($this);
        }
    ...
    public function getsfGuardUserRelatedByCreatedBy(PropelPDO $con = null)
    {
        if ($this->asfGuardUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->asfGuardUserRelatedByCreatedBy->addCartItemsRelatedByCreatedBy($this);
             */
        }
    ...
    public function setsfGuardUserRelatedByUpdatedBy(sfGuardUser $v = null)
    {
        ...
        // If this object has already been added to the sfGuardUser object, it will not be re-added.
        if ($v !== null) {
            $v->addCartItemRelatedByUpdatedBy($this);
        }
    ...
    public function getsfGuardUserRelatedByUpdatedBy(PropelPDO $con = null)
    {
        if ($this->asfGuardUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->asfGuardUserRelatedByUpdatedBy->addCartItemsRelatedByUpdatedBy($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CartItemPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    */
  try {
    if (!$callable = sfMixer::getCallable('BaseCartItem:'.$name))
    {
      throw new sfException(sprintf('Call to undefined method BaseCartItem::%s', $name));
    }
  ...
  */
  ...
  public function exportTo($parser, $includeLazyLoadColumns = true) {
	...
	public function getMetadata($info = null, $default = null) {
		return CartItemPeer::getMetadata($info, $default, get_class($this));
	}
