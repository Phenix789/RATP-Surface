...
/**
 * Base class that represents a row from the 'sfc_social_comment' table.
 *
 * 
 *
 * @package    propel.generator.plugins.surfaceSocialPlugin.lib.model.om
 */
abstract class BaseSfcComment extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'SfcCommentPeer';
    ...
    /**
     * The value for the collaborator_id field.
     * @var        int
     */
    protected $collaborator_id;
    ...
    /**
     * Get the [collaborator_id] column value.
     * 
     * @return   int
     */
     ...
     * @return   SfcComment The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = SfcCommentPeer::ID;
        }
    ...
    public function setObjectName($v)
    {
        ...
        if ($this->object_name !== $v) {
            $this->object_name = $v;
            $this->modifiedColumns[] = SfcCommentPeer::OBJECT_NAME;
        }
    ...
    public function setObjectId($v)
    {
        ...
        if ($this->object_id !== $v) {
            $this->object_id = $v;
            $this->modifiedColumns[] = SfcCommentPeer::OBJECT_ID;
        }
    ...
    public function setCategory($v)
    {
        ...
        if ($this->category !== $v) {
            $this->category = $v;
            $this->modifiedColumns[] = SfcCommentPeer::CATEGORY;
        }
    ...
    public function setComment($v)
    {
        ...
        if ($this->comment !== $v) {
            $this->comment = $v;
            $this->modifiedColumns[] = SfcCommentPeer::COMMENT;
        }
    ...
    public function setDateRef($v)
    {
        ...
        if ($this->date_ref !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SfcCommentPeer::DATE_REF;
            }
    ...
    /**
     * Set the value of [collaborator_id] column.
     * 
     * @param      int $v new value
     * @return   SfcComment The current object (for fluent API support)
     */
    public function setCollaboratorId($v)
    {
		$v = SfcUtils::numberParse($v);
        if ($v !== null) {
            $v = (int) $v;
        ...
        if ($this->collaborator_id !== $v) {
            $this->collaborator_id = $v;
            $this->modifiedColumns[] = SfcCommentPeer::COLLABORATOR_ID;
        }

        if ($this->aCollaborator !== null && $this->aCollaborator->getId() !== $v) {
            $this->aCollaborator = null;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SfcCommentPeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SfcCommentPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = SfcCommentPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = SfcCommentPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->object_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            $this->date_ref = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->collaborator_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            ...
            return $startcol + 11; // 11 = SfcCommentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SfcComment object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCollaborator !== null && $this->collaborator_id !== $this->aCollaborator->getId()) {
            $this->aCollaborator = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SfcCommentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseSfcComment:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
        ...
        try {
            $deleteQuery = SfcCommentQuery::create()
    ...
    foreach (sfMixer::getCallables('BaseSfcComment:delete:post') as $callable)
    {
    ...
    if (!$this->isSkipEdited() && !$this->isColumnModified(SfcCommentPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
    }

    if (!$this->isSkipEdited() && !$this->isColumnModified(SfcCommentPeer::UPDATED_BY))
    {
    ...
    if (!$this->isSkipEdited() && !$this->isColumnModified(SfcCommentPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if (!$this->isSkipEdited() && !$this->isColumnModified(SfcCommentPeer::CREATED_BY))
    {
      $user_id = (sfContext::getInstance() && sfContext::getInstance()->getUser() && sfContext::getInstance()->getUser()->getGuardUser())? sfContext::getInstance()->getUser()->getGuardUser()->getId() : null;
    ...
    foreach (sfMixer::getCallables('BaseSfcComment:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(SfcCommentPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(SfcCommentPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
    }
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SfcCommentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    foreach (sfMixer::getCallables('BaseSfcComment:save:post') as $callable)
    {
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCollaborator !== null) {
                if ($this->aCollaborator->isModified() || $this->aCollaborator->isNew()) {
                    $affectedRows += $this->aCollaborator->save($con);
                }
                $this->setCollaborator($this->aCollaborator);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {				
				$stmt = $con->query('SELECT sfc_social_comment_SEQ.nextval FROM dual');
				$row = $stmt->fetch(PDO::FETCH_NUM);
				$this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(SfcCommentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(SfcCommentPeer::OBJECT_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'OBJECT_NAME';
        }
        if ($this->isColumnModified(SfcCommentPeer::OBJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'OBJECT_ID';
        }
        if ($this->isColumnModified(SfcCommentPeer::CATEGORY)) {
            $modifiedColumns[':p' . $index++]  = 'CATEGORY';
        }
        if ($this->isColumnModified(SfcCommentPeer::COMMENT)) {
            $modifiedColumns[':p' . $index++]  = 'COMMENT';
        }
        if ($this->isColumnModified(SfcCommentPeer::DATE_REF)) {
            $modifiedColumns[':p' . $index++]  = 'DATE_REF';
        }
        if ($this->isColumnModified(SfcCommentPeer::COLLABORATOR_ID)) {
            $modifiedColumns[':p' . $index++]  = 'COLLABORATOR_ID';
        }
        if ($this->isColumnModified(SfcCommentPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'CREATED_AT';
        }
        if ($this->isColumnModified(SfcCommentPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'UPDATED_AT';
        }
        if ($this->isColumnModified(SfcCommentPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'CREATED_BY';
        }
        if ($this->isColumnModified(SfcCommentPeer::UPDATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'UPDATED_BY';
        }

        $sql = sprintf(
            'INSERT INTO sfc_social_comment (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aCollaborator !== null) {
                if (!$this->aCollaborator->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aCollaborator->getValidationFailures());
                }
            }


            if (($retval = SfcCommentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SfcCommentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SfcComment'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SfcComment'][$this->getPrimaryKey()] = true;
        $keys = SfcCommentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            ...
            $keys[5] => $this->getDateRef(),
            $keys[6] => $this->getCollaboratorId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aCollaborator) {
                $result['Collaborator'] = $this->aCollaborator->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setDateRef($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setCollaboratorId($arr[$keys[6]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SfcCommentPeer::ID)) $criteria->add(SfcCommentPeer::ID, $this->id);
        if ($this->isColumnModified(SfcCommentPeer::OBJECT_NAME)) $criteria->add(SfcCommentPeer::OBJECT_NAME, $this->object_name);
        if ($this->isColumnModified(SfcCommentPeer::OBJECT_ID)) $criteria->add(SfcCommentPeer::OBJECT_ID, $this->object_id);
        if ($this->isColumnModified(SfcCommentPeer::CATEGORY)) $criteria->add(SfcCommentPeer::CATEGORY, $this->category);
        if ($this->isColumnModified(SfcCommentPeer::COMMENT)) $criteria->add(SfcCommentPeer::COMMENT, $this->comment);
        if ($this->isColumnModified(SfcCommentPeer::DATE_REF)) $criteria->add(SfcCommentPeer::DATE_REF, $this->date_ref);
        if ($this->isColumnModified(SfcCommentPeer::COLLABORATOR_ID)) $criteria->add(SfcCommentPeer::COLLABORATOR_ID, $this->collaborator_id);
        if ($this->isColumnModified(SfcCommentPeer::CREATED_AT)) $criteria->add(SfcCommentPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(SfcCommentPeer::UPDATED_AT)) $criteria->add(SfcCommentPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(SfcCommentPeer::CREATED_BY)) $criteria->add(SfcCommentPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(SfcCommentPeer::UPDATED_BY)) $criteria->add(SfcCommentPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(SfcCommentPeer::DATABASE_NAME);
        $criteria->add(SfcCommentPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of SfcComment (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCollaboratorId($this->getCollaboratorId());
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 SfcComment Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return   SfcCommentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SfcCommentPeer();
        }
    ...
    public function setsfGuardUserRelatedByCreatedBy(sfGuardUser $v = null)
    {
        ...
        if ($v !== null) {
            $v->addSfcCommentRelatedByCreatedBy($this);
        }
    ...
    public function getsfGuardUserRelatedByCreatedBy(PropelPDO $con = null)
    {
        if ($this->asfGuardUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->asfGuardUserRelatedByCreatedBy->addSfcCommentsRelatedByCreatedBy($this);
             */
        }
    ...
    public function setsfGuardUserRelatedByUpdatedBy(sfGuardUser $v = null)
    {
        ...
        // If this object has already been added to the sfGuardUser object, it will not be re-added.
        if ($v !== null) {
            $v->addSfcCommentRelatedByUpdatedBy($this);
        }
    ...
    public function getsfGuardUserRelatedByUpdatedBy(PropelPDO $con = null)
    {
        if ($this->asfGuardUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->asfGuardUserRelatedByUpdatedBy->addSfcCommentsRelatedByUpdatedBy($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function setCollaborator(Collaborator $v = null)
    {
        if ($v === null) {
            $this->setCollaboratorId(NULL);
        } else {
            $this->setCollaboratorId($v->getId());
        }

        $this->aCollaborator = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Collaborator object, it will not be re-added.
        if ($v !== null) {
            $v->addSfcComment($this);
        }
     ...
     * @throws PropelException
     */
    public function getCollaborator(PropelPDO $con = null)
    {
        if ($this->aCollaborator === null && ($this->collaborator_id !== null)) {
            $this->aCollaborator = CollaboratorQuery::create()->findPk($this->collaborator_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCollaborator->addSfcComments($this);
             */
        }

        return $this->aCollaborator;
    }
    ...
    {
        return (string) $this->exportTo(SfcCommentPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    */
  try {
    if (!$callable = sfMixer::getCallable('BaseSfcComment:'.$name))
    {
      throw new sfException(sprintf('Call to undefined method BaseSfcComment::%s', $name));
    }
  ...
  */
  ...
  {
    return (string) $this->getObjectName();
  }
  ...
  public function exportTo($parser, $includeLazyLoadColumns = true) {
	...
	public function getMetadata($info = null, $default = null) {
		return SfcCommentPeer::getMetadata($info, $default, get_class($this));
	}
