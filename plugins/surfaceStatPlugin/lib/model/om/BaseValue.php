...
/**
 * Base class that represents a row from the 'stat_value' table.
 *
 * 
 *
 * @package    propel.generator.plugins.surfaceStatPlugin.lib.model.om
 */
abstract class BaseValue extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'ValuePeer';
    ...
    /**
     * The value for the continue_field_id field.
     * @var        int
     */
    protected $continue_field_id;
    ...
    /**
     * Get the [continue_field_id] column value.
     * 
     * @return   int
     */
    public function getContinueFieldId()
    {

        return $this->continue_field_id;
    }
    ...
    public function setWorksheetId($v)
    {
        ...
        if ($this->worksheet_id !== $v) {
            $this->worksheet_id = $v;
            $this->modifiedColumns[] = ValuePeer::WORKSHEET_ID;
        }
    ...
    /**
     * Set the value of [continue_field_id] column.
     * 
     * @param      int $v new value
     * @return   Value The current object (for fluent API support)
     */
    public function setContinueFieldId($v)
    {
		$v = SfcUtils::numberParse($v);
        if ($v !== null) {
            $v = (int) $v;
        ...
        if ($this->continue_field_id !== $v) {
            $this->continue_field_id = $v;
            $this->modifiedColumns[] = ValuePeer::CONTINUE_FIELD_ID;
        }

        if ($this->aContinueField !== null && $this->aContinueField->getId() !== $v) {
            $this->aContinueField = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->continue_field_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = ValuePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aContinueField !== null && $this->continue_field_id !== $this->aContinueField->getId()) {
            $this->aContinueField = null;
        }
    } // ensureConsistency
    ...
    foreach (sfMixer::getCallables('BaseValue:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseValue:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseValue:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
        ...
        try {
            ...
            $con->commit();
    foreach (sfMixer::getCallables('BaseValue:save:post') as $callable)
    {
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aContinueField !== null) {
                if ($this->aContinueField->isModified() || $this->aContinueField->isNew()) {
                    $affectedRows += $this->aContinueField->save($con);
                }
                $this->setContinueField($this->aContinueField);
            }
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aContinueField !== null) {
                if (!$this->aContinueField->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aContinueField->getValidationFailures());
                }
            }
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getContinueFieldId();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['Value'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Value'][serialize($this->getPrimaryKey())] = true;
        $keys = ValuePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getWorksheetId(),
            $keys[1] => $this->getContinueFieldId(),
        );
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aContinueField) {
                $result['ContinueField'] = $this->aContinueField->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setContinueFieldId($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ValuePeer::WORKSHEET_ID)) $criteria->add(ValuePeer::WORKSHEET_ID, $this->worksheet_id);
        if ($this->isColumnModified(ValuePeer::CONTINUE_FIELD_ID)) $criteria->add(ValuePeer::CONTINUE_FIELD_ID, $this->continue_field_id);
    ...
    {
        $criteria = new Criteria(ValuePeer::DATABASE_NAME);
        $criteria->add(ValuePeer::WORKSHEET_ID, $this->worksheet_id);
        $criteria->add(ValuePeer::CONTINUE_FIELD_ID, $this->continue_field_id);
    ...
    public function setPrimaryKey($keys)
    {
        ...
        $this->setContinueFieldId($keys[1]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getWorksheetId()) && (null === $this->getContinueFieldId());
    }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setContinueFieldId($this->getContinueFieldId());
    ...
    public function getWorksheet(PropelPDO $con = null)
    {
        if ($this->aWorksheet === null && ($this->worksheet_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aWorksheet->addValues($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a ContinueField object.
     *
     * @param                  ContinueField $v
     * @return                 Value The current object (for fluent API support)
     * @throws PropelException
     */
    public function setContinueField(ContinueField $v = null)
    {
        if ($v === null) {
            $this->setContinueFieldId(NULL);
        } else {
            $this->setContinueFieldId($v->getId());
        }

        $this->aContinueField = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ContinueField object, it will not be re-added.
        if ($v !== null) {
            $v->addValue($this);
        }
    ...
    /**
     * Get the associated ContinueField object
     *
     * @param      PropelPDO $con Optional Connection object.
     * @return                 ContinueField The associated ContinueField object.
     * @throws PropelException
     */
    public function getContinueField(PropelPDO $con = null)
    {
        if ($this->aContinueField === null && ($this->continue_field_id !== null)) {
            $this->aContinueField = ContinueFieldQuery::create()->findPk($this->continue_field_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aContinueField->addValues($this);
             */
        }

        return $this->aContinueField;
    }
    ...
    */
  try {
    if (!$callable = sfMixer::getCallable('BaseValue:'.$name))
    {
      throw new sfException(sprintf('Call to undefined method BaseValue::%s', $name));
    }
  ...
  public function exportTo($parser, $includeLazyLoadColumns = true) {
	...
	public function getMetadata($info = null, $default = null) {
		return ValuePeer::getMetadata($info, $default, get_class($this));
	}
