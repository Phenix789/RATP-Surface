...
/**
 * Base class that represents a row from the 'sfc_dashboard_message' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.dashboard.om
 */
abstract class BaseDashboardMessage extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'DashboardMessagePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        DashboardMessagePeer
     */
     ...
     * @return   DashboardMessage The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = DashboardMessagePeer::ID;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[] = DashboardMessagePeer::MESSAGE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DashboardMessagePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DashboardMessagePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = DashboardMessagePeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = DashboardMessagePeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = DashboardMessagePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating DashboardMessage object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DashboardMessagePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseDashboardMessage:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
        ...
        try {
            $deleteQuery = DashboardMessageQuery::create()
    ...
    foreach (sfMixer::getCallables('BaseDashboardMessage:delete:post') as $callable)
    {
    ...
    if (!$this->isSkipEdited() && !$this->isColumnModified(DashboardMessagePeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
    }

    if (!$this->isSkipEdited() && !$this->isColumnModified(DashboardMessagePeer::UPDATED_BY))
    {
    ...
    if (!$this->isSkipEdited() && !$this->isColumnModified(DashboardMessagePeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if (!$this->isSkipEdited() && !$this->isColumnModified(DashboardMessagePeer::CREATED_BY))
    {
      $user_id = (sfContext::getInstance() && sfContext::getInstance()->getUser() && sfContext::getInstance()->getUser()->getGuardUser())? sfContext::getInstance()->getUser()->getGuardUser()->getId() : null;
    ...
    foreach (sfMixer::getCallables('BaseDashboardMessage:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(DashboardMessagePeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(DashboardMessagePeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
    }
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DashboardMessagePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    foreach (sfMixer::getCallables('BaseDashboardMessage:save:post') as $callable)
    {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {				
				$stmt = $con->query('SELECT sfc_dashboard_message_SEQ.nextval FROM dual');
				$row = $stmt->fetch(PDO::FETCH_NUM);
				$this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(DashboardMessagePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(DashboardMessagePeer::MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = 'MESSAGE';
        }
        if ($this->isColumnModified(DashboardMessagePeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'CREATED_AT';
        }
        if ($this->isColumnModified(DashboardMessagePeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'UPDATED_AT';
        }
        if ($this->isColumnModified(DashboardMessagePeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'CREATED_BY';
        }
        if ($this->isColumnModified(DashboardMessagePeer::UPDATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'UPDATED_BY';
        }

        $sql = sprintf(
            'INSERT INTO sfc_dashboard_message (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DashboardMessagePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DashboardMessagePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['DashboardMessage'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DashboardMessage'][$this->getPrimaryKey()] = true;
        $keys = DashboardMessagePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DashboardMessagePeer::ID)) $criteria->add(DashboardMessagePeer::ID, $this->id);
        if ($this->isColumnModified(DashboardMessagePeer::MESSAGE)) $criteria->add(DashboardMessagePeer::MESSAGE, $this->message);
        if ($this->isColumnModified(DashboardMessagePeer::CREATED_AT)) $criteria->add(DashboardMessagePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(DashboardMessagePeer::UPDATED_AT)) $criteria->add(DashboardMessagePeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(DashboardMessagePeer::CREATED_BY)) $criteria->add(DashboardMessagePeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(DashboardMessagePeer::UPDATED_BY)) $criteria->add(DashboardMessagePeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(DashboardMessagePeer::DATABASE_NAME);
        $criteria->add(DashboardMessagePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of DashboardMessage (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 DashboardMessage Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return   DashboardMessagePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DashboardMessagePeer();
        }
    ...
    public function setsfGuardUserRelatedByCreatedBy(sfGuardUser $v = null)
    {
        ...
        if ($v !== null) {
            $v->addDashboardMessageRelatedByCreatedBy($this);
        }
    ...
    public function getsfGuardUserRelatedByCreatedBy(PropelPDO $con = null)
    {
        if ($this->asfGuardUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->asfGuardUserRelatedByCreatedBy->addDashboardMessagesRelatedByCreatedBy($this);
             */
        }
    ...
    public function setsfGuardUserRelatedByUpdatedBy(sfGuardUser $v = null)
    {
        ...
        // If this object has already been added to the sfGuardUser object, it will not be re-added.
        if ($v !== null) {
            $v->addDashboardMessageRelatedByUpdatedBy($this);
        }
    ...
    public function getsfGuardUserRelatedByUpdatedBy(PropelPDO $con = null)
    {
        if ($this->asfGuardUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->asfGuardUserRelatedByUpdatedBy->addDashboardMessagesRelatedByUpdatedBy($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DashboardMessagePeer::DEFAULT_STRING_FORMAT);
    }
    ...
    */
  try {
    if (!$callable = sfMixer::getCallable('BaseDashboardMessage:'.$name))
    {
      throw new sfException(sprintf('Call to undefined method BaseDashboardMessage::%s', $name));
    }
  ...
  */
  ...
  public function exportTo($parser, $includeLazyLoadColumns = true) {
	...
	public function getMetadata($info = null, $default = null) {
		return DashboardMessagePeer::getMetadata($info, $default, get_class($this));
	}
