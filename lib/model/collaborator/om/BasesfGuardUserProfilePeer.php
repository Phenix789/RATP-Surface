...
abstract class BasesfGuardUserProfilePeer {
    ...
    const COLLABORATOR_ID = 'sf_guard_user_profile.COLLABORATOR_ID';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'CollaboratorId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'collaboratorId', ),
        BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::COLLABORATOR_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'COLLABORATOR_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'collaborator_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'CollaboratorId' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'collaboratorId' => 2, ),
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::COLLABORATOR_ID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'COLLABORATOR_ID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'collaborator_id' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(sfGuardUserProfilePeer::COLLABORATOR_ID);
		} else {
    ...
    public static function doCountJoinCollaborator(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(sfGuardUserProfilePeer::COLLABORATOR_ID, CollaboratorPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of sfGuardUserProfile objects pre-filled with their Collaborator objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of sfGuardUserProfile objects.
    ...
    public static function doSelectJoinCollaborator(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (sfGuardUserProfile) to $obj2 (Collaborator)
                $obj2->addsfGuardUserProfile($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (sfGuardUserProfile) to the collection in $obj3 (Collaborator)
    ...
    public static function doSelectJoinAllExceptsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = sfGuardUserProfilePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (sfGuardUserProfile) to the collection in $obj2 (Collaborator)
                $obj2->addsfGuardUserProfile($obj1);
    ...
    /**
     * Selects a collection of sfGuardUserProfile objects pre-filled with all related objects except Collaborator.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectPK(Criteria $criteria = null, $con = null) {
		return sfGuardUserProfilePeer::doSelectFieldValues(sfGuardUserProfilePeer::ID, $criteria, true, $con);
	}
  ...
  public static function doSelectFieldValues($field, $criteria = null, $distinct = false, $con = null) {
      ...
      $column = sfGuardUserProfilePeer::getTableMap()->getColumn($field);
      $criteria->clearSelectColumns();
      $criteria->addSelectColumn($field);
      $stmt = sfGuardUserProfilePeer::doSelectStmt($criteria, $con);
      $fields = array();
	 ...
	 *
	 */
	public static function getMetadata($info = null, $default = null, $class = 'sfGuardUserProfile') {
		if(!sfGuardUserProfilePeer::$_metadata) {
			...
			sfGuardUserProfilePeer::$_metadata = array_merge($default_metadata, $metadata);
		}
		if($info) {
			return get($info, sfGuardUserProfilePeer::$_metadata, $default);
		}
		return sfGuardUserProfilePeer::$_metadata;
	}
