 ...
 */
abstract class BasesfGuardUserProfile extends BaseObject 
{
    ...
    public function setCollaboratorId($v)
    {
        ...
        if ($this->collaborator_id !== $v) {
            ...
            $this->modifiedColumns[] = sfGuardUserProfilePeer::COLLABORATOR_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->collaborator_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = sfGuardUserProfilePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setCollaboratorId($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(sfGuardUserProfilePeer::COLLABORATOR_ID)) $criteria->add(sfGuardUserProfilePeer::COLLABORATOR_ID, $this->collaborator_id);
    ...
    public function getCollaborator(PropelPDO $con = null)
    {
        if ($this->aCollaborator === null && ($this->collaborator_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCollaborator->addsfGuardUserProfiles($this);
             */
        }
  ...
  try {
    ...
    {
      throw new sfException(sprintf('Call to undefined method BasesfGuardUserProfile::%s', $name));
    }
  ...
  public function exportTo($parser, $includeLazyLoadColumns = true) {
	...
	public function getMetadata($info = null, $default = null) {
		return sfGuardUserProfilePeer::getMetadata($info, $default, get_class($this));
	}
