...
/**
 * Base static class for performing query and update operations on the 'ratp_subscription' table.
 *
 * 
 *
...
abstract class BaseSubscriptionPeer {
    ...
    const TABLE_NAME = 'ratp_subscription';
    ...
    const NAME = 'ratp_subscription.NAME';

    /** the column name for the PRICE field */
    const PRICE = 'ratp_subscription.PRICE';
    ...
    const UPDATED_AT = 'ratp_subscription.UPDATED_AT';

    /** the column name for the CREATED_BY field */
    const CREATED_BY = 'ratp_subscription.CREATED_BY';

    /** the column name for the UPDATED_BY field */
    const UPDATED_BY = 'ratp_subscription.UPDATED_BY';
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(SubscriptionPeer::UPDATED_BY);
		} else {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to ratp_subscription
    ...
    {
        $key = SubscriptionPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = SubscriptionPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + SubscriptionPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = SubscriptionPeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doCountJoinsfGuardUserRelatedByCreatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(SubscriptionPeer::CREATED_BY, sfGuardUserPeer::ID, $join_behavior);
    ...
    public static function doCountJoinsfGuardUserRelatedByUpdatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(SubscriptionPeer::UPDATED_BY, sfGuardUserPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Subscription objects pre-filled with their sfGuardUser objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinsfGuardUserRelatedByCreatedBy(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        SubscriptionPeer::addSelectColumns($criteria);
        $startcol = SubscriptionPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Subscription) to $obj2 (sfGuardUser)
                $obj2->addSubscriptionRelatedByCreatedBy($obj1);
    ...
    public static function doSelectJoinsfGuardUserRelatedByUpdatedBy(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Subscription) to $obj2 (sfGuardUser)
                $obj2->addSubscriptionRelatedByUpdatedBy($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        SubscriptionPeer::addSelectColumns($criteria);
        $startcol2 = SubscriptionPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Subscription) to the collection in $obj2 (sfGuardUser)
                $obj2->addSubscriptionRelatedByCreatedBy($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Subscription) to the collection in $obj3 (sfGuardUser)
                $obj3->addSubscriptionRelatedByUpdatedBy($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Subscription objects pre-filled with all related objects except sfGuardUserRelatedByCreatedBy.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Subscription objects pre-filled with all related objects except sfGuardUserRelatedByUpdatedBy.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
        return SubscriptionPeer::OM_CLASS;
    }
    ...
    /**
     * Performs an UPDATE on the database, given a Subscription or Criteria object.
     *
    ...
    foreach (sfMixer::getCallables('BaseSubscriptionPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(SubscriptionPeer::ID);
            if ($value) {
                $selectCriteria->add(SubscriptionPeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(SubscriptionPeer::TABLE_NAME);
            }
    ...
    /**
     * Deletes all rows from the ratp_subscription table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            SubscriptionPeer::doOnDeleteSetNull(new Criteria(SubscriptionPeer::DATABASE_NAME), $con);
            $affectedRows += BasePeer::doDeleteAll(SubscriptionPeer::TABLE_NAME, $con, SubscriptionPeer::DATABASE_NAME);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            SubscriptionPeer::doOnDeleteSetNull($c, $con);
    ...
    protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = SubscriptionPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {

            // set fkey col in related ClientSubscription rows to NULL
            $selectCriteria = new Criteria(SubscriptionPeer::DATABASE_NAME);
            $updateValues = new Criteria(SubscriptionPeer::DATABASE_NAME);
            $selectCriteria->add(ClientSubscriptionPeer::SUBSCRIPTION_ID, $obj->getId());
            $updateValues->add(ClientSubscriptionPeer::SUBSCRIPTION_ID, null);
	...
	public static function doSelectPK(Criteria $criteria = null, $con = null) {
		return SubscriptionPeer::doSelectFieldValues(SubscriptionPeer::ID, $criteria, true, $con);
	}
  ...
  public static function doSelectFieldValues($field, $criteria = null, $distinct = false, $con = null) {
      ...
      $column = SubscriptionPeer::getTableMap()->getColumn($field);
      $criteria->clearSelectColumns();
      $criteria->addSelectColumn($field);
      $stmt = SubscriptionPeer::doSelectStmt($criteria, $con);
      $fields = array();
	 ...
	 *
	 */
	public static function getMetadata($info = null, $default = null, $class = 'Subscription') {
		if(!SubscriptionPeer::$_metadata) {
			...
			SubscriptionPeer::$_metadata = array_merge($default_metadata, $metadata);
		}
		if($info) {
			return get($info, SubscriptionPeer::$_metadata, $default);
		}
		return SubscriptionPeer::$_metadata;
	}
