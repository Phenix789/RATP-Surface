...
/**
 * Base class that represents a row from the 'ratp_client_subscription' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.schema.om
 */
abstract class BaseClientSubscription extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'ClientSubscriptionPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ClientSubscriptionPeer
     */
     ...
     * @return   ClientSubscription The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ClientSubscriptionPeer::ID;
        }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[] = ClientSubscriptionPeer::CLIENT_ID;
        }
    ...
    public function setSubscriptionId($v)
    {
        ...
        if ($this->subscription_id !== $v) {
            ...
            $this->modifiedColumns[] = ClientSubscriptionPeer::SUBSCRIPTION_ID;
        }
    ...
    public function setBeginDate($v)
    {
        ...
        if ($this->begin_date !== null || $dt !== null) {
            $currentDateAsString = ($this->begin_date !== null && $tmpDt = new DateTime($this->begin_date)) ? $tmpDt->format('Y-m-d H:i:s') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d H:i:s') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->begin_date = $newDateAsString;
                $this->modifiedColumns[] = ClientSubscriptionPeer::BEGIN_DATE;
            }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientSubscriptionPeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientSubscriptionPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = ClientSubscriptionPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = ClientSubscriptionPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->subscription_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->begin_date = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 8; // 8 = ClientSubscriptionPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ClientSubscription object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ClientSubscriptionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseClientSubscription:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
        ...
        try {
            $deleteQuery = ClientSubscriptionQuery::create()
    ...
    foreach (sfMixer::getCallables('BaseClientSubscription:delete:post') as $callable)
    {
    ...
    if (!$this->isSkipEdited() && !$this->isColumnModified(ClientSubscriptionPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
    }

    if (!$this->isSkipEdited() && !$this->isColumnModified(ClientSubscriptionPeer::UPDATED_BY))
    {
    ...
    if (!$this->isSkipEdited() && !$this->isColumnModified(ClientSubscriptionPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if (!$this->isSkipEdited() && !$this->isColumnModified(ClientSubscriptionPeer::CREATED_BY))
    {
      $user_id = (sfContext::getInstance() && sfContext::getInstance()->getUser() && sfContext::getInstance()->getUser()->getGuardUser())? sfContext::getInstance()->getUser()->getGuardUser()->getId() : null;
    ...
    foreach (sfMixer::getCallables('BaseClientSubscription:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(ClientSubscriptionPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(ClientSubscriptionPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
    }
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ClientSubscriptionPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    foreach (sfMixer::getCallables('BaseClientSubscription:save:post') as $callable)
    {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {				
				$stmt = $con->query('SELECT ratp_client_subscription_SEQ.nextval FROM dual');
				$row = $stmt->fetch(PDO::FETCH_NUM);
				$this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(ClientSubscriptionPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(ClientSubscriptionPeer::CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CLIENT_ID';
        }
        if ($this->isColumnModified(ClientSubscriptionPeer::SUBSCRIPTION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SUBSCRIPTION_ID';
        }
        if ($this->isColumnModified(ClientSubscriptionPeer::BEGIN_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'BEGIN_DATE';
        }
        if ($this->isColumnModified(ClientSubscriptionPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'CREATED_AT';
        }
        if ($this->isColumnModified(ClientSubscriptionPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'UPDATED_AT';
        }
        if ($this->isColumnModified(ClientSubscriptionPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'CREATED_BY';
        }
        if ($this->isColumnModified(ClientSubscriptionPeer::UPDATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'UPDATED_BY';
        }

        $sql = sprintf(
            'INSERT INTO ratp_client_subscription (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ClientSubscriptionPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ClientSubscriptionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ClientSubscription'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ClientSubscription'][$this->getPrimaryKey()] = true;
        $keys = ClientSubscriptionPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aSubscription) {
                $result['Subscription'] = $this->aSubscription->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setBeginDate($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientSubscriptionPeer::ID)) $criteria->add(ClientSubscriptionPeer::ID, $this->id);
        if ($this->isColumnModified(ClientSubscriptionPeer::CLIENT_ID)) $criteria->add(ClientSubscriptionPeer::CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(ClientSubscriptionPeer::SUBSCRIPTION_ID)) $criteria->add(ClientSubscriptionPeer::SUBSCRIPTION_ID, $this->subscription_id);
        if ($this->isColumnModified(ClientSubscriptionPeer::BEGIN_DATE)) $criteria->add(ClientSubscriptionPeer::BEGIN_DATE, $this->begin_date);
        if ($this->isColumnModified(ClientSubscriptionPeer::CREATED_AT)) $criteria->add(ClientSubscriptionPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ClientSubscriptionPeer::UPDATED_AT)) $criteria->add(ClientSubscriptionPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(ClientSubscriptionPeer::CREATED_BY)) $criteria->add(ClientSubscriptionPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(ClientSubscriptionPeer::UPDATED_BY)) $criteria->add(ClientSubscriptionPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(ClientSubscriptionPeer::DATABASE_NAME);
        $criteria->add(ClientSubscriptionPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of ClientSubscription (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 ClientSubscription Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return   ClientSubscriptionPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ClientSubscriptionPeer();
        }
    ...
    public function getClient(PropelPDO $con = null)
    {
        if ($this->aClient === null && ($this->client_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aClient->addClientSubscriptions($this);
             */
        }
    ...
    public function getSubscription(PropelPDO $con = null)
    {
        if ($this->aSubscription === null && ($this->subscription_id !== null)) {
            $this->aSubscription = SubscriptionQuery::create()->findPk($this->subscription_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSubscription->addClientSubscriptions($this);
             */
        }
    ...
    public function setsfGuardUserRelatedByCreatedBy(sfGuardUser $v = null)
    {
        ...
        if ($v !== null) {
            $v->addClientSubscriptionRelatedByCreatedBy($this);
        }
    ...
    public function getsfGuardUserRelatedByCreatedBy(PropelPDO $con = null)
    {
        if ($this->asfGuardUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->asfGuardUserRelatedByCreatedBy->addClientSubscriptionsRelatedByCreatedBy($this);
             */
        }
    ...
    public function setsfGuardUserRelatedByUpdatedBy(sfGuardUser $v = null)
    {
        ...
        // If this object has already been added to the sfGuardUser object, it will not be re-added.
        if ($v !== null) {
            $v->addClientSubscriptionRelatedByUpdatedBy($this);
        }
    ...
    public function getsfGuardUserRelatedByUpdatedBy(PropelPDO $con = null)
    {
        if ($this->asfGuardUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->asfGuardUserRelatedByUpdatedBy->addClientSubscriptionsRelatedByUpdatedBy($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ClientSubscriptionPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    */
  try {
    if (!$callable = sfMixer::getCallable('BaseClientSubscription:'.$name))
    {
      throw new sfException(sprintf('Call to undefined method BaseClientSubscription::%s', $name));
    }
  ...
  */
  ...
  {
    return (string) $this->getBeginDate();
  }
  ...
  public function exportTo($parser, $includeLazyLoadColumns = true) {
	...
	public function getMetadata($info = null, $default = null) {
		return ClientSubscriptionPeer::getMetadata($info, $default, get_class($this));
	}
